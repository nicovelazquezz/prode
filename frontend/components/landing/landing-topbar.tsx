...
export function LandingTopbar() {
  return (
    <div className="border-b border-[var(--color-landing-line)] px-8 py-3.5 font-[family-name:var(--font-landing-mono)] text-xs tracking-wider text-[var(--color-landing-text-muted)]">
