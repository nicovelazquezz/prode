...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // backdrop spec: rgba(5, 9, 14, 0.4) — matches DESIGN.md "Modal / Dialog"
      "fixed inset-0 z-50 bg-[rgba(5,9,14,0.4)]",
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-[var(--color-prode-surface)] text-[var(--color-prode-near-black)] border border-[var(--color-prode-border)] rounded-md p-8",
        "duration-200",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
